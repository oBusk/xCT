...
/run xCTShared.ActiveProfile [FEATURE] = VALUE

Some common examples are:
*/run xCTShared.ActiveProfile.Frames.Critical.Font.Size = 22*
*/run xCTShared.ActiveProfile.Frames.Critical.Font.Style = "THICKOUTLINE"*
*/run xCTShared.ActiveProfile.ClassKilled = false*

*/run xCTShared.ActiveProfile.Frames.Healing.Enabled = false*
*/run xCTShared.ActiveProfile.Frames.Healing.Secondary = "Damage"*
