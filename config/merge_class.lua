...
addon.merges[224239]    = CreateMergeSpellEntry("PALADIN", 1.0, 70)         -- Artifact: Echo of the Highlord (Divine Storm)
addon.merges[224266]    = CreateMergeSpellEntry("PALADIN", 0.5, 70)         -- Artifact: Echo of the Highlord (Templar's Verdict)
