...
-- Setup up values
local ssub, pairs, tostring, tonumber, math, unpack, print, type, random, table_insert, format, _G
  = string.sub, pairs, tostring, tonumber, math, unpack, print, type, math.random, table.insert, string.format, _G
